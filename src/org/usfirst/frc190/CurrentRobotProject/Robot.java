...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS        
        ...
        autoChooser.addObject("Don't - Mobility", new AutoMobilityOnly());
        autoChooser.addObject("Don't - Old One Ball From Low Goal", new OneBallAutoClose());
        autoChooser.addDefault("Pick This One - One Ball Moving Shot", new OneBallAutoFar());
        autoChooser.addObject("Don't - Test Two Ball", new TwoBallAutoOld());
