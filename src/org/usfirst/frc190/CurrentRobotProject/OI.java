...
public class OI {
    ...
    public JoystickButton humanPlayerCollectButton;
    public JoystickButton teleopOneBallAutomated;
    public JoystickButton collectStoredPositionButton;
    ...
    public JoystickButton doNothing_PassButton;
    ...
    public OI() {
        ...
        doNothing_PassButton = new JoystickButton(oIJoystick2, 9);
        doNothing_PassButton.whenPressed(new DoNothing());
        ...
        autoAbortButton = new JoystickButton(rightJoystick, 6);
        autoAbortButton.whenPressed(new StoreSequence());
        collectStoredPositionButton = new JoystickButton(rightJoystick, 3);
        collectStoredPositionButton.whenPressed(new CollectStoredPosition());
        teleopOneBallAutomated = new JoystickButton(rightJoystick, 11);
        teleopOneBallAutomated.whenPressed(new OneBallAutoClose());
        humanPlayerCollectButton = new JoystickButton(rightJoystick, 1);
        humanPlayerCollectButton.whenPressed(new HumanPlayerCollect());
